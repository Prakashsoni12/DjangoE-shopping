...
class Category(models.Model):
    ...
    meta_keyboards = models.CharField(max_length=150, null=False, blank=False)
...
class Product(models.Model):
    ...
    product_image = models.ImageField(
        upload_to=get_file_path, null=True, blank=False)
    small_description = models.CharField(
        max_length=250, null=False, blank=False)
    quantity = models.IntegerField(null=False, blank=False)
    descrition = models.TextField(max_length=500, null=False, blank=False)
...
class Order(models.Model):
    ...
    total_price = models.CharField(max_length=250, null=False)
